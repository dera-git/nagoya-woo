...
class MoneticoPaiement_Ept {
	...
	function __construct($sLangue = "FR") {
		...
		$aRequiredConstants = array('MONETICOPAIEMENT_KEY', 'MONETICOPAIEMENT_VERSION', 'MONETICOPAIEMENT_EPTNUMBER', 'MONETICOPAIEMENT_COMPANYCODE', 'MONETICOPAIEMENT_URLOK', 'MONETICOPAIEMENT_URLKO');
