...
<?php endif; ?>
		...
		<div class="container">
			<div class="kl-woocommerce-form-login">
				<form class="woocommerce-form woocommerce-form-login login" method="post">

					<?php do_action( 'woocommerce_login_form_start' ); ?>

					<p class="woocommerce-form-row woocommerce-form-row--wide mb-3 form-row form-row-wide">
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<div class="container">
			<div class="kl-woocommerce-form-register">
